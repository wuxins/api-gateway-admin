...
@Entity
@Data
@Table(name = "t_upstream_service_version")
@DynamicInsert
@DynamicUpdate
public class UpstreamServiceVersion implements Serializable {
    ...
    @Column(name = "`env`")
    @ApiModelProperty(value = "service env")
    private String env;
    ...
    public void copy(UpstreamServiceVersion source) {
